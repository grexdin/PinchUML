...
*(https://forum.plantuml.net/4834/activation-shorthand-for-sequence-diagrams?show=13054#c13054), QA-9573 and QA-13234]*
...
* ``nosolid``/``solid``
Since v1.2025.5, old ``skinparam lifelineStrategy solid`` no longer works.
*(https://forum.plantuml.net/9016/), QA-2794]*
...
*(https://github.com/plantuml/plantuml/pull/2266) and GH-2662]*
...
*(https://forum.plantuml.net/4750) and QA-6410]*
...
*(https://forum.plantuml.net/4019) and Issue#148]*
